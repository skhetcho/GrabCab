            ...
            <View style={styles.mainView}>
                ...
                <View style={styles.bodyContainer}>
                    <View style={styles.todaysIncomeContainer}>
                       ...
                       <Text style={styles.todayEarningMoneyText}>{Currency}{this.state.today?this.state.today.toFixed(2):'0'}</Text>
                    </View>
                    <View style={styles.listContainer}>
                      <View style={styles.totalEarning}>
                        <Text style={styles.todayEarningHeaderText2}>{languageJSON.thismonth}</Text>
                        <Text style={styles.todayEarningMoneyText2}>{Currency}{this.state.thisMothh?this.state.thisMothh.toFixed(2):'0'}</Text>
                      </View>
                      <View style={styles.thismonthEarning}>
                        <Text style={styles.todayEarningHeaderText2}>{languageJSON.totalearning}</Text>
                        <Text style={styles.todayEarningMoneyText2}>{Currency}{this.state.totalEarning?this.state.totalEarning.toFixed(2):'0'}</Text>
                      </View>
                    </View>
               </View>
           </View>
