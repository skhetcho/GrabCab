                    ...
                    <View style={styles.billView}>
                        ...
                        <View style={styles.billOptions}>
                            <View style={styles.billItem}>
                                ...
                                <Text style={styles.billAmount}>{this.state.paramData ? Currency +this.state.paramData.trip_cost.toFixed(2) : "0"}</Text>
                            </View>
                            <View style={styles.billItem}>
                                <View>
                                ...
                                <Text style={styles.billAmount}>{this.state.paramData && this.state.paramData.convenience_fees? '-'+ Currency +this.state.paramData.convenience_fees.toFixed(2) : "0"}</Text>
                            </View>
                        </View>
                        <View style={styles.paybleAmtView}>
                            <Text style={[styles.billTitle,{color:'green'}]}>{languageJSON.total_payable}</Text>
                            <Text style={[styles.billTitle,{color:'green'}]}>{this.state.paramData && this.state.paramData.driver_share? Currency +this.state.paramData.driver_share.toFixed(2) : "0"}</Text>
                        </View>
                    </View>
                    :null:null}
                        ...
                        <View>
                            ...
                            <View style={styles.billOptions}>
                                ...
                                <View style={{flexDirection:'column'}}>  
                                    {this.state.paramData &&  this.state.paramData.cashPaymentAmount ?<Text style={styles.payDetails}>{languageJSON.CashPaymentAmount}  {this.state.paramData &&  this.state.paramData.cashPaymentAmount ? '$'+this.state.paramData.cashPaymentAmount.toFixed(2) :'$'+ 0}</Text>:null}
                                    {this.state.paramData &&  this.state.paramData.cardPaymentAmount ?<Text style={styles.payDetails}>{languageJSON.CardPaymentAmount}  {this.state.paramData &&  this.state.paramData.cardPaymentAmount ? '$'+this.state.paramData.cardPaymentAmount.toFixed(2) :'$'+ 0}</Text>:null}
                                    {this.state.paramData &&  this.state.paramData.usedWalletMoney ? <Text style={styles.payDetails}>{languageJSON.WalletPayment}       {this.state.paramData &&  this.state.paramData.usedWalletMoney ? '$'+this.state.paramData.usedWalletMoney.toFixed(2) :'$'+ 0}</Text>:null}
                                </View>:null}
                                <View style={styles.billItem}>
                                    <Text style={styles.billAmount}>{languageJSON.discount_amount}</Text>
                                    <Text style={styles.billAmount}>{this.state.paramData && this.state.paramData.discount_amount ? '$'+this.state.paramData.discount_amount.toFixed(2) : '$'+0}</Text>
                                </View>
                            </View>
                        </View>
                        :null:null}
