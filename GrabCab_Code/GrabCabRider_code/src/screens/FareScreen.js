    ...
    async getDirections(startLoc, destLoc) {
        try {
            ...
            this.setState({
                ...
                convenience_fees: fareCalculation ? fareCalculation.convenience_fees.toFixed(2) : 0
            }, () => {
                            ...
                            <View style={styles.upperContainer}>
                                <View style={styles.fareDetailsContainer}>
                                    ...
                                    <View style={styles.farePriceContainer}>
                                        ...
                                        <Text style={styles.farePriceText}>{Currency} {this.state.convenience_fees ? this.state.convenience_fees : 0} </Text>
                                    </View>
                                </View>
