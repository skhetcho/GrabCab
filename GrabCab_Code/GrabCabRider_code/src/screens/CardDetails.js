...
export default class CardDetailsScreen extends React.Component {
  ...
  payWithCard() {
    ...
    let payData = {
      ...
      amount: this.state.payDetails.payableAmmount.toFixed(2),
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollStyle}>
          <View style={{ flex: 1, flexDirection: 'column' }}>
            ...
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 25, paddingRight: 25 }}>
              ...
              <Text style={{ color: '#BB1E1E', textAlign: 'left', lineHeight: 45, fontSize: 16 }}>- {Currency} {this.state.payDetails ? this.state.payDetails.discount ? this.state.payDetails.discount.toFixed(2) : '0.00' : '0.00'}</Text>
            </View>
