...
export default class DriverTripComplete extends React.Component {
    ...
    render(){
        ...
        <Text style={styles.rateViewTextStyle}>{Currency}{this.state.getDetails?this.state.getDetails.customer_paid>0?this.state.getDetails.customer_paid.toFixed(2):0:null}</Text>
                </View>
