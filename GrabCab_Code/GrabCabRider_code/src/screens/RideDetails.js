                ...
                <ScrollView>
                    ...
                    <View style={styles.rideDesc}>
                        ...
                        <Avatar
                            ...
                            /> */}
                            <View style={styles.userView}>
                        <Text style={styles.textStyle}>{Currency}{this.state.paramData && this.state.paramData.customer_paid?this.state.paramData.customer_paid.toFixed(2):this.state.paramData && this.state.paramData.estimate?this.state.paramData.estimate:0 }</Text>
                            </View>
                        </View>
                    </View> 
                   ...
                   />
                    ...
                    <View style={styles.billView}>
                        ...
                        <Text style={styles.billAmount}>{Currency} {this.state.paramData && this.state.paramData.trip_cost>0?this.state.paramData.trip_cost.toFixed(2):this.state.paramData && this.state.paramData.estimate?this.state.paramData.estimate.toFixed(2):0 }</Text>
                            ...
                            {this.state.paramData && this.state.paramData.cardPaymentAmount?this.state.paramData.cardPaymentAmount>0?
                                <View style={styles.billItem}>
                                    ...
                                    <Text >  {Currency}{this.state.paramData && this.state.paramData.cardPaymentAmount?this.state.paramData.cardPaymentAmount.toFixed(2):0}</Text>
                            ...
                            :null:null}
                             {this.state.paramData && this.state.paramData.cashPaymentAmount?this.state.paramData.cashPaymentAmount>0?
                                <View style={styles.billItem}>
                                    ...
                                    <Text>  {Currency}{this.state.paramData && this.state.paramData.cashPaymentAmount?this.state.paramData.cashPaymentAmount.toFixed(2):0}</Text>
                            ...
                            :null:null}
                             {this.state.paramData && this.state.paramData.usedWalletMoney?this.state.paramData.usedWalletMoney>0?
                                <View style={styles.billItem}>
                                    ...
                                    <Text >  {Currency}{this.state.paramData && this.state.paramData.usedWalletMoney?this.state.paramData.usedWalletMoney.toFixed(2):0}</Text>
                        ...
                        <Text style={styles.billAmount2}>{Currency}{this.state.paramData && this.state.paramData.customer_paid?this.state.paramData.customer_paid.toFixed(2):null}</Text>
                        </View>
                    </View>
                    :null:null}
                     {this.state.paramData && this.state.paramData.payment_status?this.state.paramData.payment_status == "IN_PROGRESS" || this.state.paramData.payment_status == "PAID" || this.state.paramData.payment_status == "WAITING"?
