            ...
            <TouchableOpacity style={styles.iconClickStyle} onPress={() => this.onPressButton(item, index)}>
                ...
                <View style={styles.flexViewStyle}>
                    ...
                    <View style={styles.textView2}>
                        ...
                        <Text style={[styles.fareStyle, styles.dateStyle]}>{item.status == 'END' && item.payment_status == 'PAID' ? item.customer_paid ? Currency + item.customer_paid.toFixed(2) : Currency + parseFloat(item.estimate).toFixed(2) : null}</Text>
                        {
